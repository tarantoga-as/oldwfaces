...
public class WearConfigActivity
        extends Activity //WearableActivity
...
//    public int      mTzHemisphere = AppPreferences.DEFAULT_HEMISPHERE;
    ...
    public boolean mConsumeData = true;
...
//        LocalBroadcastManager.getInstance(WearConfigActivity.this).unregisterReceiver(mDataFromWearServiceReceiver);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mElements = new String[2];
        mElements[0] = this.getResources().getString(R.string.elm_phone_battery); //, //"Phone battery",
        mElements[1] = "Consume data";
...
//        new IntentFilter(ACommon.EVENT_ACTION));
        ...
        mShowHandheldBattery = ((CommonApplication) getApplication()).getHandheldBatteryTrigger();
        mConsumeData = ((CommonApplication) getApplication()).getConsumeDataTrigger();



        setContentView(R.layout.wear_config_activity);
    ...
    public void onClick(WearableListView.ViewHolder viewHolder) {
        ...
        switch (tag) {
            case 0:
                ...
                ((CommonApplication) getApplication()).setHandheldBatteryTrigger(!mShowHandheldBattery);
                break;
            case 1:
                ((CommonApplication) getApplication()).setConsumeDataTrigger(!mConsumeData);
                break;
//            case 0:
...
//                    icon.setImageResource(opticon);
                    break;
                case 1:
                    optname = mDataset[position] + ": " + ((true == mConsumeData) ? "clear" : "set");
                    text.setText(optname);
                    break;
//                case 0:
